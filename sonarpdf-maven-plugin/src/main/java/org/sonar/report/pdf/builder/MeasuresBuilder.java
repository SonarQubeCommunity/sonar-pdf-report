...
public class MeasuresBuilder {
	 ...
	 */
	private void initMeasuresSplittingRequests(Measures measures, final String projectKey)
			throws HttpException, IOException {
	 ...
	 */
	private void addMeasures(Measures measures, final List<String> measuresAsString,
