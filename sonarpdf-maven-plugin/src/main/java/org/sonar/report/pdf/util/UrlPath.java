...
public class UrlPath {
  ...
  public static final String MOST_VIOLATED_INFO_RULES = "&metrics=" + MetricKeys.INFO_VIOLATIONS + "&filter_rules=false&filter_rules_cats=true";
  public static final String MOST_VIOLATED_MINOR_RULES = "&metrics=" + MetricKeys.MINOR_VIOLATIONS + "&filter_rules=false&filter_rules_cats=true";
