...
public class DefaultPDFReporter extends PDFReporter {
    ...
    private void printDashboard(Project project, Section section) throws DocumentException {
        ...
        linesOfCode.addCell(new Phrase(project.getMeasure("duplicated_lines_ratio").getFormatValue()
        ...
        comments
                .addCell(new Phrase(project.getMeasure("comment_lines").getFormatValue() + " comment lines", dataFont2));
